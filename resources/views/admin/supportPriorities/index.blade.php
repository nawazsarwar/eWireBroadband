...
@can('support_priority_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.support-priorities.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-SupportPriority">
            <thead>
                <tr>
                    <th width="10">
...
@can('support_priority_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.support-priorities.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.support-priorities.index') }}",
    columns: [
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-SupportPriority').DataTable(dtOverrideGlobals);
