...
@can('support_status_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.support-statuses.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-SupportStatus">
            <thead>
                <tr>
                    <th width="10">
...
@can('support_status_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.support-statuses.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.support-statuses.index') }}",
    columns: [
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-SupportStatus').DataTable(dtOverrideGlobals);
