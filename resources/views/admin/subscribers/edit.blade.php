        ...
        <form method="POST" action="{{ route("admin.subscribers.update", [$subscriber->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                <div class="col-md-4">
                    ...
                    <input class="form-control {{ $errors->has('username') ? 'is-invalid' : '' }}" type="text" name="username" id="username" value="{{ old('username', $subscriber->username) }}" required disabled>
            ...
            <div class="form-group row">
                <div class="col-md-4">
                    ...
                    <input class="form-control {{ $errors->has('subscriberid') ? 'is-invalid' : '' }}" type="text" name="subscriberid" id="subscriberid" value="{{ old('subscriberid', $subscriber->subscriberid) }}" required disabled>
                ...
                <div class="col-md-4">
                    ...
                    <select class="form-control" name="location" id="location" required>
                        ...
                        @foreach (config('railwire.locations') as $location)
                            <option value="{{ $location['code'] }}" @if( $location['code'] == $subscriber->location ) selected @endif>{{ $location['name'] }}</option>
                        @endforeach
                    </select>
