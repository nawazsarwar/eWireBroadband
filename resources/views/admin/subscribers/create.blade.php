        ...
        <form method="POST" action="{{ route("admin.subscribers.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    ...
                    <input class="form-control {{ $errors->has('mobileno') ? 'is-invalid' : '' }}" type="text" name="mobileno" id="mobileno" value="{{ old('mobileno', '') }}" required>
            ...
            <div class="form-group row">
                <div class="col-md-6">
                    ...
                    <input class="form-control {{ $errors->has('alternate_mobile_no') ? 'is-invalid' : '' }}" type="text" name="alternate_mobile_no" id="alternate_mobile_no" value="{{ old('alternate_mobile_no', '') }}">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    ...
                    <input class="form-control {{ $errors->has('packagename') ? 'is-invalid' : '' }}" type="text" name="packagename" id="packagename" value="{{ old('packagename', '') }}">
            ...
            <div class="form-group row">
                <div class="col-md-6">
                    ...
                    <input class="form-control {{ $errors->has('billingtypeid') ? 'is-invalid' : '' }}" type="text" name="billingtypeid" id="billingtypeid" value="{{ old('billingtypeid', '') }}">
                ...
                <div class="col-md-6">
                    ...
                    <input class="form-control {{ $errors->has('subscriberid') ? 'is-invalid' : '' }}" type="text" name="subscriberid" id="subscriberid" value="{{ old('subscriberid', '') }}" required>
            ...
            <div class="form-group row">
                <div class="col-md-6">
                    ...
                    <input class="form-control datetime {{ $errors->has('expiry') ? 'is-invalid' : '' }}" type="text" name="expiry" id="expiry" value="{{ old('expiry') }}">
                ...
                <div class="col-md-6">
                    ...
                    <input class="form-control datetime {{ $errors->has('registrationdate') ? 'is-invalid' : '' }}" type="text" name="registrationdate" id="registrationdate" value="{{ old('registrationdate') }}">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    ...
                    <input class="form-control {{ $errors->has('sub_status') ? 'is-invalid' : '' }}" type="text" name="sub_status" id="sub_status" value="{{ old('sub_status', '') }}">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <label class="required" for="location">{{ trans('cruds.subscriber.fields.location') }}</label>
                    <select class="form-control" name="location" id="location" required>
                        <option value="">Select</option>
                        @foreach (config('railwire.locations') as $location)
                    ...
                    @endif
                    <span class="help-block">{{ trans('cruds.subscriber.fields.location_helper') }}</span>
                </div>
            </div>
