                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.subscribers.update", [$subscriber->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="username" id="username" value="{{ old('username', $subscriber->username) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="firstname" id="firstname" value="{{ old('firstname', $subscriber->firstname) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="lastname" id="lastname" value="{{ old('lastname', $subscriber->lastname) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="mobileno" id="mobileno" value="{{ old('mobileno', $subscriber->mobileno) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="alternate_mobile_no" id="alternate_mobile_no" value="{{ old('alternate_mobile_no', $subscriber->alternate_mobile_no) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="email" name="email" id="email" value="{{ old('email', $subscriber->email) }}" required>
                            @if($errors->has('email'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('email') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="address" id="address" value="{{ old('address', $subscriber->address) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="packagename" id="packagename" value="{{ old('packagename', $subscriber->packagename) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="billingtypeid" id="billingtypeid" value="{{ old('billingtypeid', $subscriber->billingtypeid) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="subscriberid" id="subscriberid" value="{{ old('subscriberid', $subscriber->subscriberid) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="gstin" id="gstin" value="{{ old('gstin', $subscriber->gstin) }}">
                            @if($errors->has('gstin'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('gstin') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="status" id="status" value="{{ old('status', $subscriber->status) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="expiry" id="expiry" value="{{ old('expiry', $subscriber->expiry) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="registrationdate" id="registrationdate" value="{{ old('registrationdate', $subscriber->registrationdate) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="balance" id="balance" value="{{ old('balance', $subscriber->balance) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="sub_status" id="sub_status" value="{{ old('sub_status', $subscriber->sub_status) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="remarks" id="remarks" value="{{ old('remarks', $subscriber->remarks) }}">
