                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.support-tickets.update", [$supportTicket->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="auther_name" id="auther_name" value="{{ old('auther_name', $supportTicket->auther_name) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="email" name="author_email" id="author_email" value="{{ old('author_email', $supportTicket->author_email) }}">
