                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.orders.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="transacted_on" id="transacted_on" value="{{ old('transacted_on') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="merchant_order" id="merchant_order" value="{{ old('merchant_order', '') }}">
