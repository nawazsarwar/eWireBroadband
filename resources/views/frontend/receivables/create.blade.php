    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.receivables.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label for="financeref">{{ trans('cruds.receivable.fields.financeref') }}</label>
                            <input class="form-control" type="number" name="financeref" id="financeref" value="{{ old('financeref', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="lastupdate" id="lastupdate" value="{{ old('lastupdate') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="subscriberid" id="subscriberid" value="{{ old('subscriberid', '') }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="amount_received" id="amount_received" value="{{ old('amount_received', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="settled" id="settled">
                                ...
                                @foreach(App\Models\Receivable::SETTLED_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('settled', 'No') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="settled_at" id="settled_at" value="{{ old('settled_at') }}">
